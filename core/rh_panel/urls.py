...
urlpatterns = [
    ...
    path('capture/', views.CaptureLocationView.as_view(), name='capture_attendance'),
    path('capture/office', views.CaptureLocationOfficeView.as_view(), name='capture_attendance'),
